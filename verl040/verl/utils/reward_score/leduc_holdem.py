...
def compute_score(solution_str: str, ground_truth, extra_info):
    """
    Compute the reward score based on the solution string and ground truth for Leduc Hold'em.
    Uses the same scoring logic as Kuhn Poker since both games use identical output formats.
